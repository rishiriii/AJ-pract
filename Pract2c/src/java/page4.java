...
public class page4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<a href=page1><h3>Click to view page 1</a></h3><br>");
            out.println("<a href=page2><h3>Click to view page 2</a></h3><br>");
            out.println("<a href=page3><h3>Click to view page 3</a></h3><br>");
            out.println("<a href=Logout><h3>Terminate Session</a></h3>");
            out.println("</body>");
            out.println("</html>");
        }
    }
